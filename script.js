...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Solo ejecuta el código del carrusel si el elemento 'heroSection' existe en la página actual
    if (heroSection) {
        // 1. Creamos una lista (array) con las imágenes que queremos mostrar
        const images = [
        ...
        // 2. Empezamos en la primera imagen
        let currentImageIndex = 0;
    
        // 3. Creamos una función que cambia la imagen de fondo
        function changeBackgroundImage() {
            currentImageIndex = (currentImageIndex + 1) % images.length;
            heroSection.style.backgroundImage = images[currentImageIndex];
        }
    
        // 4. Hacemos que la función se ejecute cada 5 segundos
